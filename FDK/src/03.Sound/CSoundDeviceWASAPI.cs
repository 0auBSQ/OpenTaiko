...
internal class CSoundDeviceWASAPI : ISoundDevice {
	...
	public CSoundDeviceWASAPI(EWASAPIMode mode, long bufferSize, long interval) {
		...
		this.nMixer1SecondByteCount = nMixer1SamplePerByteCount * mixerInfo.Frequency;
	...
	protected int tWASAPIProcess(IntPtr buffer, int length, IntPtr user) {
		...
		this.dbElapsedTimeMs = (this.nCumulativeTransferByteCount - nUnplayedByteCount) * 1000.0 / this.nMixer1SecondByteCount;
		...
		long nThisTimeDelayms = nUnplayedByteCount * 1000 / this.nMixer1SecondByteCount;
	...
	private long nMixer1SecondByteCount = 0;
