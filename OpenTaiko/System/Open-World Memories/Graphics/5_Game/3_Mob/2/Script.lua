...
-- Mob 2: a three-layer crowd that rises in when the gauge tops out (100), bobs to the BPM, then drops back out.
...
function onStart()
    ...
    mob_height = tx["Mob_Front.png"].Height   -- sync load → size is valid here
end
