...
return {
	...
	["Moving %s   ·   point at a wall slot (low/high) · %s · [Esc] cancels"] = "%sを移動中 ・ 壁のスロット（上/下）を指して・%s・[Esc]でキャンセル",
	["Moving %s   ·   wheel rotates · %s · [Esc] cancels"] = "%sを移動中 ・ ホイールで回転・%s・[Esc]でキャンセル",
	...
	["Placing %s   ·   wheel rotates · click a green spot · [Esc] cancels"] = "%sを配置中 ・ ホイールで回転・緑の場所をクリック・[Esc]でキャンセル",
	["Placing %s   ·   wheel flips low/high mount · click a green spot · [Esc] cancels"] = "%sを配置中 ・ ホイールで上下切替・緑の場所をクリック・[Esc]でキャンセル",
	["Painting %s   ·   click & drag to apply many · [Esc] cancels"] = "%sを塗装中 ・ クリック＆ドラッグで連続適用・[Esc]でキャンセル",
