    ...
    internal class CLang_zh : ILang
    {
		...
		"— 0：自上至下斜向\n" +
            ...
            [18] = "此选项作用不明，会导致CPU占用增加，\n" +
                "并且当曲目播放速度低于0.9x时可能会出现问题。",
            [19] = "切换全屏/窗口模式。",
            [20] = "移植DTXMania导致的无效设置\n" +
                "没有任何作用",
            [21] = "选择随机选曲时是否访问子文件夹",
            [22] = "选择是否开启垂直同步。打开后帧率会保持60fps，音符滚动会更加顺畅，\n" +
                "但输入延迟会增加。\n" +
                "关闭后帧率不会受到限制，输入延迟会降低，\n" +
                "但音符滚动会更加不稳定",
            [23] = "选择是否开启背景视频。", +
		"若此选项开启但文件夹中没有视频，背景会变为全黑",
            ...
            [25] = "曲目预览等待时间\n" +
                ...
                "范围：0—10000ms",
            [26] = "移植DTXMania导致的无效设置\n" +
                "没有任何作用",
            [27] = "选择是否开启debug模式。开启后右下角会显示额外信息\n" +
                "敲击音效关闭时会显示延迟校准。",
		...
		"— 0—99：降低音量，\n" +
            ...
            [43] = "ASIO：\n" +
                ...
                "— 输入延迟最高。\n" +
                "退出设置界面以使此选项生效。",
            [44] = "不出现如曲目冻结或时间错误的声音问题时该项设置越小越好。\n" +
            ...
            [53] = "显示迷你角色图片。",
            [54] = "从System文件夹中选择皮肤。\n（安装皮肤时请将皮肤文件夹放入system文件夹中重启游戏并在此选择）",
            [55] = "二级菜单：设置系统按键",
            [56] = "玩家1自动演奏",
            [57] = "玩家1自动演奏开关\n" +
                "在选曲界面按F3可快捷开关此项。",
	    ...
	    [9994] = "材质加载方式:\n" +
    		"启动时不会未响应。\n" +
		"如果某些贴图变黑，请关闭这项设置。\n" +
		"该项设置将会在关闭Opentaiko后生效。\n",
            [9995] = "异步纹理加载",

            [9996] = "绘制方式:\n" +
                    "从 OpenGL , Vulkan , DirectX11, or DirectX12 中选择。\n" +
                    "OpenGL 速度较慢，但稳定性和兼容性较好。\n" +
                    "Vulkan 在 Linux 上速度最快。\n" +
                    "DirectX11 较快且稳定， 但只能在 Windows 上使用。\n" +
                    "DirectX11 效率很高， 但只能在 Windows 上使用。\n"
                    "\n" +
                    "该想设置将会在游戏重启后生效。\n",
            [9997] = "画面渲染 API",
