...
internal class CActConfigList : CActivity {
	...
	public void tItemListSettings_System(bool refresh = true) {
		...
		if (OperatingSystem.IsIOS()) {
			...
			this.listItemList.Add(this.iSystemIOSFrameRate);
		} else {
	...
	public void tItemListSettings_Drums() {
		...
		if (OperatingSystem.IsIOS()) {
			...
			this.listItemList.Add(this.iTouchDrumVisual);
		}
	...
	private void tConfigIniRecord_Drums() {
		...
		if (OperatingSystem.IsIOS()) {
			OpenTaiko.ConfigIni.nTouchDrumVisual = this.iTouchDrumVisual.nCurrentValue;
		}
