...
internal class CActConfigList : CActivity {
	...
	#region [ tItemListSettings_System() ]
	...
	// Gameplay options
	#region [ tItemListSettings_Drums() ]
	...
	public void tEnterPressed() {
		...
		//太鼓のキー設定。
			...
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.LRed);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoRRed) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.RRed);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoLBlue) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.LBlue);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoRBlue) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.RBlue);
		}

		//太鼓のキー設定。2P
		else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoLRed2P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.LRed2P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoRRed2P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.RRed2P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoLBlue2P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.LBlue2P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoRBlue2P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.RBlue2P);
		}

		//太鼓のキー設定。3P
		else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoLRed3P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.LRed3P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoRRed3P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.RRed3P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoLBlue3P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.LBlue3P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoRBlue3P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.RBlue3P);
		}

		//太鼓のキー設定。4P
		else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoLRed4P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.LRed4P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoRRed4P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.RRed4P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoLBlue4P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.LBlue4P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoRBlue4P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.RBlue4P);
		}

		//太鼓のキー設定。5P
		else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoLRed5P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.LRed5P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoRRed5P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.RRed5P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoLBlue5P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.LBlue5P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTaikoRBlue5P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.RBlue5P);
		}

		// Konga claps
		else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignKongaClap) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.Clap);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignKongaClap2P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.Clap2P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignKongaClap3P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.Clap3P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignKongaClap4P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.Clap4P);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignKongaClap5P) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.Clap5P);
		}

		// Menu controls
		else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignDecide) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.Decide);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignCancel) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.Cancel);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignLeftChange) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.LeftChange);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignRightChange) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.RightChange);
		}
		...
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignSystemNewHeya) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.System, EKeyConfigPad.NewHeya);
		...
		// Training controls
			...
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingPause);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingToggleAuto) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingToggleAuto);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingBookmark) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingBookmark);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingIncreaseScrollSpeed) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingIncreaseScrollSpeed);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingDecreaseScrollSpeed) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingDecreaseScrollSpeed);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingIncreaseSongSpeed) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingIncreaseSongSpeed);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingDecreaseSongSpeed) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingDecreaseSongSpeed);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingBranchNormal) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingBranchNormal);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingBranchExpert) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingBranchExpert);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingBranchMaster) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingBranchMaster);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingMoveForwardMeasure) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingMoveForwardMeasure);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingMoveBackMeasure) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingMoveBackMeasure);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingSkipForwardMeasure) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingSkipForwardMeasure);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingSkipBackMeasure) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingSkipBackMeasure);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingJumpToFirstMeasure) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingJumpToFirstMeasure);
		} else if (this.listItemList[this.nCurrentSelectedItem] == this.iKeyAssignTrainingJumpToLastMeasure) {
			OpenTaiko.stageConfig.tPadSelectedNotify(EKeyConfigPart.Drums, EKeyConfigPad.TrainingJumpToLastMeasure);
		}
		#endregion
		else {
			// #27029 2012.1.5 from
	...
	public void tItemListSettings_KeyAssignSystem() {
		...
		this.listItemList.Add(this.iKeyAssignSystemNewHeya);
	...
	public int Draw(bool bItemListSideFocus) {
		...
		while ((nCurrentTime - this.nScrollTimerValue) >= INTERVAL) {
			...
			//-----------------
			#endregion
			#region [ this.n現在のスクロールカウンタに nAcceleration を加減算。]
			//-----------------
	...
	private void tConfigIniRecord_Drums() {
		...
		OpenTaiko.ConfigIni.nMinDisplayedCombo.Drums = this.iSystemMinComboDrums.nCurrentValue;
