	...
	public override int Draw() {
		...
		*/
		...
		// 曲データの一覧取得中は、キー入力を無効化する
			...
			if (OpenTaiko.Pad.bPressed(EKeyConfigPart.Taiko, EPad.SD) || OpenTaiko.Pad.bPressed(EKeyConfigPart.Taiko, EPad.LeftChange)) {
				this.tCursorTopMove();
			}
			...
			if (OpenTaiko.Pad.bPressed(EKeyConfigPart.Taiko, EPad.LT) || OpenTaiko.Pad.bPressed(EKeyConfigPart.Taiko, EPad.RightChange)) {
