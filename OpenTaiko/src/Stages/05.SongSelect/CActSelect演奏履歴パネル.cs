...
internal class CActSelect演奏履歴パネル : CActivity {
	...
	public override int Draw() {
		if (!base.IsDeActivated) {
			...
			int x = 980;
			int y = 350;
			if (OpenTaiko.stageSongSelect.r現在選択中のスコア != null && this.ct登場アニメ用.CurrentValue >= 2000 && OpenTaiko.SongMount.rCurrentlySelectedSong.nodeType == CSongListNode.ENodeType.SCORE) {
