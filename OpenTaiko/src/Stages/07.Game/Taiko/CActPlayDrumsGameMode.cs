	...
	private void tTatakikiriShow_EvaluateRemainingTimeExtend() {
		...
		if (this.nLastTimeExtendTime + 11000 <= tja.GameTimeToTjaTime(SoundManager.PlayTimer.NowTimeMs)) {
			...
			if (OpenTaiko.stageGameScreen.nHitCount_ExclAuto.Drums.Perfect != 0 || OpenTaiko.stageGameScreen.nHitCount_ExclAuto.Drums.Great != 0) {
				double dbTotalAccuracy = ((double)(OpenTaiko.stageGameScreen.nHitCount_ExclAuto.Drums.Perfect + OpenTaiko.stageGameScreen.nHitCount_ExclAuto.Drums.Great) / this.stTatakikiriShow.nSectionNoteCount) * 100.0;
			...
			double dbTotalMissRate = (((double)OpenTaiko.stageGameScreen.nHitCount_ExclAuto.Drums.Poor + OpenTaiko.stageGameScreen.nHitCount_ExclAuto.Drums.Miss) / this.stTatakikiriShow.nCurrentPassedNoteCount) * 100.0;
