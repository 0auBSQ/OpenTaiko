...
- 上記のリリースのバージョン以外でサポートは行いません、CommitのPreReleaseを使う場合は自己責任でお願いします。
...
知的所有権侵害を支援しておりませんので、自国の著作権規則に応じて使ってください。
...
- カスタマイズ手段を増えてスキンニングのポテンシャルを拡大すること、「みんなが簡単に自分のスタイルの太鼓をやれる」事実を可能にすること。
