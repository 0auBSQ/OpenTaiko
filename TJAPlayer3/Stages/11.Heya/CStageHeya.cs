        ...
        public override int On進行描画()
        {
            ...
            if (iCurrentMenu == 1)
            {
                for (int i = -5; i < 6; i++)
                {
                    ...
                    TJAPlayer3.Tx.Characters_Normal[pos][0]?.t2D拡大率考慮中央基準描画(TJAPlayer3.app.Device, 620 + 302 * i, 320);
            ...
            if (iCurrentMenu == 3)
            {
                for (int i = -5; i < 6; i++)
                {
                    ...
                    if (TJAPlayer3.NamePlateConfig.data.NamePlateTitles[iPlayer].ContainsKey(this.ttkTitles[pos].str文字))
                ...
                TJAPlayer3.Pad.b押された(E楽器パート.DRUMS, Eパッド.RRed))
            {
                ...
                else if (iCurrentMenu == 3)
                {
                    ...
                    if (TJAPlayer3.NamePlateConfig.data.NamePlateTitles[iPlayer].ContainsKey(this.ttkTitles[iTitleCurrent].str文字))
