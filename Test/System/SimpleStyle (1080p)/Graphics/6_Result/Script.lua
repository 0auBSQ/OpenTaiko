...
local cloud_x = { 963, 918, 978, 1722, 1770, 168, 12, 1632, 1650, 48, 618 }
local cloud_y = { 303, 636, 954, 795, 954, 954, 153, 78, 162, 489, 966 }
local cloud_move = { 225, 180, 270, 90, 135, 225, 180, 75, 67, 180, 270 }

local shine_count = 6

local shine_x = { 
    { 1327,1882,1087,1335,1737,1710 }, 
    { 592, 37, 832, 585, 183, 210}
}

local shine_y = { 
    { 975, 607, 967, 630, 303, 877 },
    { 975, 607, 967, 630, 303, 877 }
}
